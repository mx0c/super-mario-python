...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.15.0",
                "include directory": r"../../pip-build-env-dtbp1zss/overlay/lib/python3.10/site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"/private/var/folders/76/zy5ktkns50v6gt5g8r0sf6sc0000gn/T/cibw-run-73jfxkej/cp310-macosx_arm64/build/venv/bin/python",
            "version": "3.10",
        },
    }
)
